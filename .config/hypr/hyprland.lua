...
hl.env("HYPRCURSOR_THEME", "catppuccin-macchiato-teal-cursors")
...
hl.bind(
	"Print",
	hl.dsp.exec_cmd(
		"grimblast save area - | satty --filename - --output-filename ~/Pictures/screenshots/satty-$(date '+%Y%m%d-%H:%M:%S').png"
	)
)

-- Zoomer
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("woomer --monitor DP-3"))
